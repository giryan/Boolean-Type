...
template<int Len> class strcmp
{
    int operator()(char * const str1, char * const str2)
    {
        ...
        return strcmp<Len-1>(str1+1,str2+1);
    }
};
template<> class strcmp<0>
{
    int operator()(char * const str1, char * const str2)
    {
        return 0;
...
bool Equal(Boolean boolean1, Boolean boolean2)
{
    ...
    if(boolean1len > boolean2len)
        return 1;
    else if(boolean1len < boolean2len)
        return -1;
    
    switch(boolean1len)
    { 
    case 0:
        strcmp<0>(boolean1, boolean2); 
    case 1:
        strcmp<1>(boolean1, boolean2); 
    case 2:
        strcmp<2>(boolean1, boolean2); 
    case 3:
        strcmp<3>(boolean1, boolean2); 
    case 4:
        strcmp<4>(boolean1, boolean2); 
    case 5:
        strcmp<5>(boolean1, boolean2); 
    case 6:
        strcmp<6>(boolean1, boolean2); 
    case 7:
        strcmp<7>(boolean1, boolean2); 
    case 8:
        strcmp<8>(boolean1, boolean2); 
    case 9:
        strcmp<9>(boolean1, boolean2); 
    case 10:
        strcmp<10>(boolean1, boolean2); 
    default:
        return 1;
    }
}
